...
class DecisionGraphExtractor:
    ...
    def _build_input_meta(self) -> dict[str, dict]:
        """Build {field_name: {description, unit, type}} from law YAML input + sources."""
        meta: dict[str, dict] = {}
    ...
    def extract(self) -> KnowledgeGraph:
        ...
        # Collect rule infos (needed for FACT/THRESHOLD connections)
        rule_infos = self._collect_rule_infos()
